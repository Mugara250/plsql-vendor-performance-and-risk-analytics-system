...
DATAFILE 'C:\ORACLE\ORADATA\ORCL\mon_12345_john_VendorScoring_DB\users01.dbf' 
SIZE 100M AUTOEXTEND ON NEXT 50M MAXSIZE 1G
FILE_NAME_CONVERT = ('C:\ORACLE\ORADATA\ORCL\PDBSEED\', 
                     'C:\ORACLE\ORADATA\ORCL\mon_12345_john_VendorScoring_DB\');
...
SHOW con_name;
SELECT name, open_mode FROM v$pdbs WHERE name LIKE '%VENDORSCORING%';
